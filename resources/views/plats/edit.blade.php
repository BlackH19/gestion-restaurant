            ...
            <div class="card-body">
                <form action="{{ route('plats.update', $plat) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nom_plat" id="nom_plat" class="form-control" value="{{ $plat->nom_plat }}"
                            required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0" name="prix_unitaire" id="prix_unitaire" class="form-control"
                            value="{{ $plat->prix_unitaire }}" required>
                    </div>
