...
@section('content')
    <script src="{{ assert('commandes/js/create.js') }}"></script>
                    ...
                    <div class="card-body">
                        <form id="commandeForm" action="{{ route('serveur.commande.create') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="table_numero" name="table_numero" required
                                    min="1">
                            </div>
                            ...
                            <div id="plats-wrapper">
                                <div class="row mb-3 plat-item">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" name="plats[0][quantite]" class="form-control" min="1"
                                            required>
                                    </div>
                            ...
                            <button type="button" id="add-plat" class="btn btn-secondary ">
                        ...
                        @forelse($commandes as $commande)
                            <div class="mb-3 p-2 border-bottom">
                                ...
                                @if($commande->statut !== 'servie')
                                    <form action="{{ route('serveur.commande.service', $commande->id) }}" method="POST"
                                        class="mt-2">
                                        @csrf
